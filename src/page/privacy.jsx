...
import '../assets/css/page/privacy.css';
...
const title = await request().catch((code) => { console.error(); });

document.title = title ? 'プライバシーポリシー | ' + title.name : 'プライバシーポリシー';
    ...
    <>
      ...
      <div class={styles.l_container}>
        <main class={styles.l_main}>
          <h2 class={styles.c_title}>プライバシーポリシー</h2>
          {title ? title.name : null}（以下、「当社」といいます。）は、本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における、ユーザーの個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下、「本ポリシー」といいます。）を定めます。<br />
          <br />
          <h3 class={styles.privacy}>第1条（個人情報）</h3>
          ...
          <br />
          <h3 class={styles.privacy}>第2条（個人情報の収集方法）</h3>
          当社は、ユーザーが利用登録をする際に氏名、生年月日、住所、電話番号、メールアドレス、運転免許証番号などの個人情報をお尋ねすることがあります。<br />
          また、ユーザーと提携先などとの間でなされたユーザーの個人情報を含む取引記録や決済に関する情報を,当社の提携先（情報提供元、広告主、広告配信先などを含みます。以下、｢提携先｣といいます。）などから収集することがあります。<br />
          <br />
          <h3 class={styles.privacy}>第3条（個人情報を収集・利用する目的）</h3>
          ...
          ・有料サービスにおいて、ユーザーに利用料金を請求するため 上記の利用目的に付随する目的<br />
          <br />
          <h3 class={styles.privacy}>第4条（利用目的の変更）</h3>
          ...
          <br />
          <h3 class={styles.privacy}>第5条（個人情報の第三者提供）</h3>
          ...
          ・利用目的に第三者への提供を含むこと 第三者に提供されるデータの項目 第三者への提供の手段または方法<br />
          ・本人の求めに応じて個人情報の第三者への提供を停止すること 本人の求めを受け付ける方法<br />
          <br />
          ...
          <br />
          <h3 class={styles.privacy}>第6条（個人情報の開示）</h3>
          ...
          <br />
          本人または第三者の生命、身体、財産その他の権利利益を害するおそれがある場合 当社の業務の適正な実施に著しい支障を及ぼすおそれがある場合 その他法令に違反することとなる場合 前項の定めにかかわらず、履歴情報および特性情報などの個人情報以外の情報については、原則として開示いたしません。<br />
          <br />
          <h3 class={styles.privacy}>第7条（個人情報の訂正および削除）</h3>
          ...
          <br />
          <h3 class={styles.privacy}>第8条（個人情報の利用停止等）</h3>
          ...
          <br />
          <h3 class={styles.privacy}>第9条（プライバシーポリシーの変更）</h3>
          ...
          <br />
          <h3 class={styles.privacy}>第10条（お問い合わせ窓口）</h3>
          本ポリシーに関するお問い合わせは、下記の窓口までお願いいたします。<br />
          <br />
          {/* 住所：{title ? title.address : null}<br /> */}
          社名：{title ? title.name : null}<br />
          Eメールアドレス：{title ? title.mail : null}<br />
          <br />
          以上
        </main>
        <Side />
